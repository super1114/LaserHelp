                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-4">
                                <a href="{{route('customers')}}"><p><span style="font-size: 23px; font-style: italic;">LaserHelp</span> &nbsp;&nbsp;&nbsp; <span style="font-style: italic;">Customer Program</span></p></a>
                            </div>
                            @if (Route::has('login'))
                            <div class="col-sm-12 col-md-12 col-lg-8 text-right">                            
                            @auth
                                <a href="{{ url('/home') }}" class="top_btn active_top_btn" >Submit Question</a>
                                <a href="{{ url('/home') }}" class="top_btn">Screenshare</a>
                                <a href="{{ url('/home') }}" class="top_btn">My profile</a>                                
                            @else
